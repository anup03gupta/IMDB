...
/*        if (!ModelSingletone.create().isEmpty()){
            this.data = ModelSingletone.create().getDatasource();
        }*/
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ImageView imageViewMovie = (ImageView) view.findViewById(R.id.imageView1);

        // -- Set Value --

        overviewTV.setText(data.get(i).get(ResultActivity.TAG_OVERVIEW));
        
        popularityTV.setText(data.get(i).get(ResultActivity.TAG_POPULARITY));
        titleTV.setText(data.get(i).get(ResultActivity.TAG_NAME));
        releaseTV.setText(data.get(i).get(ResultActivity.TAG_RELEASE));
        String imagePath = ResultActivity.urlb+data.get(i).get(ResultActivity.TAG_POSTER);
